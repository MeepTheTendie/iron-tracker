...
type ProgramExercise = {
  ...
  exercises: ExerciseNode // The joined data
}
  ...
  if (!program) {
    return (
      <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 text-center">
        ...
        <p className="text-blue-700 mt-1">Focus on your 10k steps and the Bike.</p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="divide-y divide-gray-100">
        {program.program_exercises.map((item, index) => (
          <div key={item.id} className="p-4 flex flex-col gap-2 hover:bg-gray-50 transition-colors">
            ...
            {/* Notes Section (Only shows if note exists) */}
