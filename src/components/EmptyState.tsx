  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border-2 border-gray-100 overflow-hidden">
      <div className={`${colors.bg} p-8 text-center`}>
        <div
          className={`w-16 h-16 ${colors.light} rounded-xl flex items-center justify-center mx-auto mb-4`}
        >
          {icon}
        </div>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border-2 border-gray-100 overflow-hidden">
      <div className="bg-sky-200 p-8 text-center">
        ...
        <p className="text-sky-600 opacity-70 text-sm">
          Take a rest day or start a custom workout
        </p>
      </div>
      <div className="p-4">
        <button
